...
export interface RelatedContentViewModel {
   ...
   * The reposted event
   */
  reposting?: NostrViewModelSet<NoteViewModel<AccountRaw>>;
   ...
   */
  reposted: NostrViewModelSet<NoteViewModel<AccountRaw>, AccountRaw>;
   ...
   */
  mentioned: NostrViewModelSet<NoteViewModel<AccountRaw>, AccountRaw>;

  /**
   * Data about repling and be replied.
   */
  reply: NoteReplyContext<AccountRaw>;
}
